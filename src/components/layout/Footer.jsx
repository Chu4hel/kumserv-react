                ...
                <div className="container py-5">
                    <div className="row g-5">
                        <div className="col-lg-3 col-md-6">
                            ...
                            <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>Чебоксары бул. Анатолия
                                Миттова, 21А, Чебоксары г-ж 58</p>
                            ...
                            <div className="d-flex pt-2">
                                <a className="btn btn-outline-light btn-social" href="https://t.me/KUMSKIYSTO"
                                   target="_blank" rel="noopener noreferrer" title="Telegram Канал"><i
                                    className="fab fa-telegram-plane"></i></a>
                                <a className="btn btn-outline-light btn-social" href="https://t.me/Oleg_Andriyanovich"
