            ...
            */}
                    ...
                    <div className="col-lg-6">
                        <div className={inView ? 'animated fadeIn' : 'animate-on-scroll'}
                            ...
                            <h1 className="mb-4"><span className="text-primary">Кумский сервис</span> в Чебоксарах - лучшее место для
                                вашего авто</h1>
                            <p className="mb-4">Автосервис "Кумский" в Юго-Западном районе (ЮЗР) г. Чебоксары стремится предоставлять исключительные услуги по
