      ...
      <div className="container">
        <div className="row g-5">
          ...
          <div className="col-lg-6">
            <div className={inView ? 'animated fadeIn' : 'animate-on-scroll'} style={inView ? { animationDelay: '0.3s' } : {}}>
              <h6 className="text-primary text-uppercase">// О нас //</h6>
              <h1 className="mb-4"><span className="text-primary">Кумский сервис</span> - лучшее место для вашего авто</h1>
              <p className="mb-4">В Кумском сервисе мы стремимся предоставлять исключительные услуги по ремонту автомобилей. Наша команда опытных механиков использует только высококачественные запчасти и современное оборудование для обеспечения наилучшего ухода за вашим автомобилем. Мы гордимся своей работой и стремимся превзойти ваши ожидания при каждом посещении.</p>
            </div>
            ...
            <a href="/about" className={`btn btn-primary py-3 px-5 ${inView ? 'animated fadeIn' : 'animate-on-scroll'}`} style={inView ? { animationDelay: '1.1s' } : {}}>Читать далее<i className="fa fa-arrow-right ms-3"></i></a>
          </div>
        </div>
      </div>
    </div>
